...
# prompt.py 文件中定义的 prompt_201 (PS) 和 prompt_301 到 prompt_307 (PS+)
...
prompt_307 = "Let's first understand the problem, extract relevant variables and their corresponding numerals, " \
             ...
             "(pay attention to correct numerical calculation and commonsense), " \
             "solve the problem step by step, and show the answer."
prompt_401 = '''Let's solve this problem using programming concepts and show the final answer:
1. First, let's understand the problem:
   - Define input variables and their data types
   - Identify the expected output format

2. Then, let's design the solution:
   - Write pseudocode to outline the logic
   - Define necessary functions and operations
   - Plan the control flow (if/else, loops)

3. Next, let's implement the solution step by step:
   - Initialize and declare variables
   - Execute the planned operations
   - Calculate intermediate results
   - Handle edge cases and exceptions
   - Track the computation process
...
Remember to show all intermediate steps and calculations clearly, and ensure the final answer is clearly marked.'''
